...
class CommandLineParser : public Utility::NoCopy
{
public:
	CommandLineParser();
	~CommandLineParser();
...
private:
	typedef std::map<Utility::HashedString, CommandLineItem*>	CommandLineOptions;
	typedef std::pair<Utility::HashedString, CommandLineItem*>	CommandLineOptionsType;
