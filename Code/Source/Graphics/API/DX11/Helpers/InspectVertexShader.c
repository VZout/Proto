...
void InspectVertexShader(ID3DBlob *a_ByteCode, D3D11_INPUT_ELEMENT_DESC **a_InputLayoutDesc, uint32_t *a_InputLayoutDataByteSize)
{
	...
	DX11ConstantBuffer **a_ConstantBufferDescs = NULL;
